            ...
            <li class="nav-item {{ ( request()->is('admin/*') ) ? 'active' : '' }}">
                ...
                <div id="collapseTwo" class="collapse {{ ( request()->is('admin/*') ) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ ( request()->is('admin/role*') ) ? 'active' : '' }}" href="/admin/role">Peranan</a>
                        <a class="collapse-item {{ ( request()->is('admin/user*') ) ? 'active' : '' }}" href="/admin/user">Pengguna</a>
                        <a class="collapse-item {{ ( request()->is('admin/plan*') ) ? 'active' : '' }}" href="/admin/plan">Pelan Langganan</a>
                        <a class="collapse-item {{ ( request()->is('admin/payment*') ) ? 'active' : '' }}" href="/admin/payment">Bayaran</a>
                    </div>
                </div>
            </li>
